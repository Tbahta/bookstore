    ...
    n.extend(b.prototype, {
        ...
        o.isClosing ||
          ...
          l(e) && e.parent().length
            ...
            : t.hasError ||
              ...
              t.opts.filter && (e = n("<div>")(e).find(t.opts.filter))),
      ...
      updateControls: function () {
        ...
        o.$slide.trigger("refresh"),
          r && r.length
            ? ((t.$caption = s), s.children().eq(0)(r))
            : (t.$caption = null),
          t.hasHiddenControls || t.isIdle || t.showControls(),
          a.find("[data-fancybox-count]")(t.group.length),
          a.find("[data-fancybox-index]")(i + 1),
          a
    ...
    function s(t) {
      t.after(
        e("<div></div>")
          ...
          .attr(
            "tabindex",
            t.attr("disabled") ? null : "0"
          )('<span class="current"></span><ul class="list"></ul>')
      );
      var s = t.next(),
        n = t.find("option"),
        i = t.find("option:selected");
      s.find(".current")(i.data("display") || i.text()),
        n.each(function (t) {
          var n = e(this),
            i = n.data("display");
          s.find("ul").append(
