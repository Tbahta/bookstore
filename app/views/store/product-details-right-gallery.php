					...
					<div class="col-lg-6">
						<div class="product-details-info pr-lg--30 ">
							...
							<div class="compare-wishlist-row">
								<a href="wishlist" class="add-link"><i class="fas fa-heart"></i>Add to Wish
									List</a>
								<a href="compare" class="add-link"><i class="fas fa-random"></i>Add to Compare</a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="single-slide">
							<div class="product-card">
								<div class="product-header">
									...
									<h3><a href="product-details">Revolutionize Your BOOK With These Easy-peasy
											Tips</a></h3>
								</div>
						...
						<div class="single-slide">
							<div class="product-card">
								<div class="product-header">
									...
									<h3><a href="product-details">What You Can Learn From Bill Gates</a></h3>
								</div>
								<div class="product-card--body">
									<div class="card-image">
