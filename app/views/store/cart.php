										...
										<tbody>
											...
											<tr>
												...
												<td class="pro-thumbnail"><a href="#"><img
															src="<?=ASSETS?>store/image/products/product-1.jpg" alt="Product"></a></td>
											...
											<tr>
												...
												<td class="pro-thumbnail"><a href="#"><img
															src="<?=ASSETS?>store/image/products/product-2.jpg" alt="Product"></a></td>
												<td class="pro-title"><a href="#">Rinosin Glasses</a></td>
												<td class="pro-price"><span>$395.00</span></td>
												<td class="pro-quantity">
													<div class="pro-qty">
								...
								<div class="single-slide">
									<div class="product-card">
										<div class="product-header">
											...
											<h3><a href="<?=ROOT?>product-details">Revolutionize Your BOOK With These
								...
								<div class="single-slide">
									<div class="product-card">
										<div class="product-header">
											...
											<h3><a href="<?=ROOT?>product-details">Turn Your BOOK Into High Machine</a></h3>
										</div>
										<div class="product-card--body">
											<div class="card-image">
								...
								<div class="single-slide">
									<div class="product-card">
										<div class="product-header">
											...
											<h3><a href="<?=ROOT?>product-details">3 Ways Create Better BOOK With</a></h3>
										</div>
										<div class="product-card--body">
											<div class="card-image">
												<img src="<?=ASSETS?>store/image/products/product-3.jpg" alt="">
												<div class="hover-contents">
													<a href="p<?=ROOT?>roduct-details" class="hover-image">
														<img src="<?=ASSETS?>store/image/products/product-2.jpg" alt="">
													</a>
													<div class="hover-btns">
														<a href="<?=ROOT?>cart" class="single-btn">
								...
								<div class="single-slide">
									<div class="product-card">
										<div class="product-header">
											...
											<h3><a href="<?=ROOT?>product-details">What You Can Learn From Bill Gates</a>
											</h3>
										</div>
										<div class="product-card--body">
											<div class="card-image">
								...
								<div class="single-slide">
									<div class="product-card">
										<div class="product-header">
											...
											<h3><a href="<?=ROOT?>product-details">Simple Things You To Save BOOK</a></h3>
										</div>
										<div class="product-card--body">
											<div class="card-image">
